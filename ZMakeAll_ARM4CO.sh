pushd Test1/
    ...
    flang -std=f2018 -O2 -march=native gfortran.F90      -o bin/flang.x
    flang -std=f2018 -O3 -march=native gfortran.F90      -o bin/flang_o3.x
    flang -std=f2018 -O2 -march=native gfortran_w_lu2.F90 -o bin/flang_w_lu2.x
    flang -std=f2018 -O3 -march=native gfortran_w_lu2.F90 -o bin/flang_w_lu2_o3.x
    flang -std=f2018 -O2 -march=native gfortran_w_lu4.F90 -o bin/flang_w_lu4.x
    flang -std=f2018 -O2 -march=native gfortran_w_lu8.F90 -o bin/flang_w_lu8.x
...
pushd Test3/
    ...
    g++ -std=c++17 -O2 -march=native gpp.cc      -o bin/clang.x
    g++ -std=c++17 -O3 -march=native gpp.cc      -o bin/clang_o3.x
